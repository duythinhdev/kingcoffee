...
export const environment = {
  ...
  version: '323',
  build: 1,
  // apiBaseUrl: 'http://api-ecommerce.tni.dev.ncs.int/v1',
  // webUserUrl: 'http://user-ecommerce.tni.dev.ncs.int',
  // sellerUrl: 'http://seller-ecommerce.tni.dev.ncs.int',
  // // investUrl: 'http://api-invest.nichietsuvn.com/api/v1',
  // apiBaseUrl: 'http://api-ecommerce.nichietsuvn.com/v1',
  // // investUrl: 'http://api-invest.tni.dev.ncs.int/api/v1',
  // investUrl: 'http://api-invest.nichietsuvn.com/api/v1',
  // tniDSCUrl:  'http://tni-postapi.dsc.vn/api',

  // Dev
  // apiBaseUrl: 'http://api-ecommerce.tni.dev.ncs.int/v1',
  // investUrl: 'http://api-invest.tni.dev.ncs.int/api/v1',
  // tniDSCUrl:  'http://tni-postapi.dsc.vn/api',
  // identityUrl: 'http://api-identity.tni.dev.ncs.int/api/v1',
  ...
  // investWebUrl: 'http://web-invest-v2.tni.stg.nichietsuvn.com',
  // webUserUrl: 'http://user-ecommerce.tni.stg.nichietsuvn.com',
  ...
  // investUrl: 'https://we40-invest.fdssoft.com/api/v1',
  // identityUrl: 'https://we40-identity.fdssoft.com/api/v1',
  // tniDSCUrl: 'https://we40-inventory-api.fdssoft.com/api',
  // investWebUrl:'https://we40-web-invest.fdssoft.com',
  // webUserUrl: 'https://we40-ecommerce-admin.fdssoft.com',
  ...
  dsc_key: 'Bh3awvkF12039hueHdu873JkidOAB',
  tni_apikey : 'ffb46d2c-c318-490d-9de8-f79255af74fa'
  // tni_apikey : 'rL`CN>5]q^mcR*Bq'
};
