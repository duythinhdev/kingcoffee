...
import { RequestPayOutTitle, RequestPayOutTitleModel } from '../../model/requestpayout.listing.title.model';
...
export class ListingComponent implements OnInit {
  requestPayOutTitleModel: RequestPayOutTitleModel;
  public items = [];
  ...
  constructor(private payoutService: RequestPayoutService,
    private toasty: ToastrService, private productService: ProductService,
    private translate: TranslateService) {
  }

  ngOnInit() {
    this.requestPayOutTitleModel = RequestPayOutTitle[0];
    this.query();
    this.queryStats();
  }
