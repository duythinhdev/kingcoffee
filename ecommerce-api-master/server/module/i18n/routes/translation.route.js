...
module.exports = (router) => {
   ...
   * @apiGroup I18N
   * @apiVersion 1.0.0
   * @api {get} /v1/i18n/translations/update/textId Update all translation which don't have textID
   * @apiDescription Update all translation which don't have textID
   *  @apiPermission admin
   */

  router.get(
    '/v1/i18n/translations/update/textId',
    Middleware.hasRole('admin'),
    translationController.updateTranslationId,
    Middleware.Response.success('updated')
  );
   ...
   * @apiGroup I18N
   * @apiVersion 1.0.0
   * @api {get} /v1/i18n/translations?page&take&sort&sortType&lang Get list text
