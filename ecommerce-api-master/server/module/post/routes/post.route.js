...
module.exports = (router) => {
   ...
   * @apiGroup Post
   * @apiVersion 1.0.0
   * @api {get} /v1/posts/shortlist Get post details without content
   * @apiDescription Get post details without content
   * @apiParam {String}   id        post id
   * @apiPermission all
   */
   ...
   */
  router.post(
    '/v1/posts/updatePostAlias',
    Middleware.hasRole("admin"),
    postController.updateAliasForAllPost,
