...
exports.hook = async (req, res, next) => {
  try {
    ...
    // I can confirm that when a recurring payment is executed, one is notified via webhook event.js PAYMENT.SALE.COMPLETED
    // as described here: https://github.com/paypal/PayPal-Python-SDK/issues/132#issuecomment-261374087
    // JSON structure of the webhook event.js:
    // {
    //    ...
    //    "resource": {
    //        ...
    ...
    //    ...
    // }
    // A list of all event.js names can be found here: https://developer.paypal.com/docs/integration/direct/webhooks/event-names/
    // TODO - validate me
