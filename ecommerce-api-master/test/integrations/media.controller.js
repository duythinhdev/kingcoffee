...
describe('Test media', () => {
  ...
  xit('Should upload a photo', async () => {
  ...
  xit('Should get details a photo', async () => {
  ...
  xit('Should upload a video', async () => {
  ...
  xit('Should get details a video', async () => {
